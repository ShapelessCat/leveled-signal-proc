...
(~(previous_session_id == session_id)).peek().add_metric("is_session_start_interval")
...
(~(previous_navigation_id == navigation_id)).peek().add_metric("is_navigation_switch_start_interval")
