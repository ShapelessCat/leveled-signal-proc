...
attempt_event = SignalFilterBuilder(input_signal.video_event).filter_values(VE_ATEMPT).build_clock_filter()
...
player_state = SignalFilterBuilder(input_signal.video_event).filter_values(VE_BUFFER, VE_PLAY).build_value_filter()
